...
export default class ProjectStrings {
    ...
    public static Talkulizer = new Project(
        "Talkulizer", 
        "I loved the music visualizer that came with iTunes way back when. I've always found a lack of options for customizing visualizers online, so I wanted to make one that was easy to play around with."
    );
